...
public class Rs2Settings {
    ...
    public static final int SETTINGS_INTERFACE = 8781825;
    public static final int SETTINGS_SEARCHBAR = 8781834;
    public static final int ALL_SETTINGS_BUTTON = 7602208;
