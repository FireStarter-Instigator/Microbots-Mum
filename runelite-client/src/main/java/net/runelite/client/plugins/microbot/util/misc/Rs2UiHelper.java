...
public class Rs2UiHelper {
    ...
    public static Rectangle getActorClickbox(Actor actor) {
        ...
        // FIXED: Added Microbot.getClient().getTopLevelWorldView() as the second argument
        Shape clickbox = Microbot.getClientThread().runOnClientThreadOptional(() -> Perspective.getClickbox(
                        Microbot.getClient(),
