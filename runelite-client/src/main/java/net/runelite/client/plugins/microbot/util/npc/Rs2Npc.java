...
public class Rs2Npc {
    ...
    public static boolean hasVisibleHealthBar(Rs2NpcModel npc) {
     ...
     */
    public static boolean attack1(String npcName) {
        return attack1(Collections.singletonList(npcName));
    }
     ...
     */
    public static boolean attack1(List<String> npcNames) {
