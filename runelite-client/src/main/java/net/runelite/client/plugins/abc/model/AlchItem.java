package net.runelite.client.plugins.abc.model;

import lombok.Getter;
import net.runelite.client.plugins.abc.util.IntegerUtil;
...
public class AlchItem {
    ...
    public AlchItem(String name,int itemId, int gePrice, int highAlchPrice, int highAlchProfit, int geLimit, boolean isMembers, BufferedImage image) {
        this.name = name;
        this.itemId = itemId;
