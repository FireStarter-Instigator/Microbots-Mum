...
import net.runelite.client.plugins.abc.model.SoundEffect;
...
public interface AbcAlchConfig extends Config {
    ...
    // NEW: Item filtering configuration
    @ConfigItem(
            keyName = "filterUselessItems",
            name = "Filter useless items",
            description = "Hide trimmed armor (g/t), castle wars armor (h3/h4/h5), and other cosmetic variants",
            section = miscSection,
            position = 8
    )
    default boolean filterUselessItems() {
        return true;
    }
}
