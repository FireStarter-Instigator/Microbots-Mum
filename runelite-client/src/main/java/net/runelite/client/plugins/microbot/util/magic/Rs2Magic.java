...
public class Rs2Magic {
    ...
    /**
     * Checks if the currently selected auto-cast spell is anything except Fire Strike.
     *
     * @return true if autocasting something other than Fire Strike, false if Fire Strike or no spell.
     */
    public static boolean isNotFireStrikeAutocast() {
        Rs2CombatSpells current = getCurrentAutoCastSpell();
        return current != null && current != Rs2CombatSpells.FIRE_STRIKE;
    }
