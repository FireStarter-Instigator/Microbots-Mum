...
public class ShortestPathPlugin extends Plugin implements KeyListener {
    ...
    protected void startUp() {
        ...
        setPanel(panel); // ✅ Make sure panelInstance is set here
    ...
    private static ShortestPathPanel panelInstance;

    public void setPanel(ShortestPathPanel panel) {
        panelInstance = panel;
    }

    public static void walkToViaPanel(WorldPoint destination) {
        if (panelInstance != null) {
            panelInstance.startWalking(destination);
        } else {
            Microbot.log("ShortestPathPanel not initialized.");
        }
    }
